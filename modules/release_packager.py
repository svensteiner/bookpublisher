...
_TOP_README_TEXT: str = (
    ...
    "\n"
    "1. Doppelklick auf 'BookPublisher starten.bat'.\n"
    "   Der Launcher startet automatisch die richtige Version:\n"
    "     - 'BookPublisher.exe' falls vorhanden (kein Python noetig).\n"
    "     - Sonst 'python gui.py' (nur fuer Entwickler-Setup).\n"
    "2. Das Fenster oeffnet sich mit dem Ordner 'beispielbuch' bereits\n"
    "   ausgewaehlt. Du musst nichts mehr klicken zum Auswaehlen.\n"
    ...
    "klickst du im Fenster auf 'Ordner waehlen' und waehlst deinen\n"
    "Buchordner statt 'beispielbuch'.\n"
    "\n"
    "Falls beim Start eine Meldung ueber fehlendes Python kommt:\n"
    "Du brauchst die EXE-Version von der Homepage - die laeuft ohne\n"
    "jede Vorinstallation.\n"
    "\n"
